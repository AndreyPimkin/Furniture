package ru.penza.builtfurniture.POJO;
...
public class OneStrings {
    ...
    public OneStrings(String stringOne, String stringTwo, String stringThree) {
    ...
    public OneStrings(String stringOne, String stringTwo, String stringThree, String stringFour, String stringFive, String stringSix) {
        this.stringOne = stringOne;
        this.stringTwo = stringTwo;
        this.stringThree = stringThree;
        this.stringFour = stringFour;
